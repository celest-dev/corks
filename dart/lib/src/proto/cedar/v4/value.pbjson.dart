...
final $typed_data.Uint8List valueDescriptor = $convert.base64Decode(
    ...
    'oDc2V0GAQgASgLMhIuY2VkYXIudjQuU2V0VmFsdWVIAFIDc2V0Ei8KBnJlY29yZBgFIAEoCzIV'
    'LmNlZGFyLnY0LlJlY29yZFZhbHVlSABSBnJlY29yZBJACg5leHRlbnNpb25fY2FsbBgGIAEoCz'
    'IXLmNlZGFyLnY0LkV4dGVuc2lvbkNhbGxIAFINZXh0ZW5zaW9uQ2FsbBIvCgZlbnRpdHkYByAB'
    'KAsyFS5jZWRhci52NC5FbnRpdHlWYWx1ZUgAUgZlbnRpdHkSMgoHZGVjaW1hbBgIIAEoCzIWLm'
    'NlZGFyLnY0LkRlY2ltYWxWYWx1ZUgAUgdkZWNpbWFsQgcKBXZhbHVl');
...
final $typed_data.Uint8List setValueDescriptor = $convert.base64Decode(
    'CghTZXRWYWx1ZRIrCghlbGVtZW50cxgBIAMoCzIPLmNlZGFyLnY0LlZhbHVlUghlbGVtZW50cw'
    '==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cedar.v4.RecordValue.AttributesEntry',
      '10': 'attributes'
    },
  ],
...
final $typed_data.Uint8List recordValueDescriptor = $convert.base64Decode(
    'CgtSZWNvcmRWYWx1ZRJFCgphdHRyaWJ1dGVzGAEgAygLMiUuY2VkYXIudjQuUmVjb3JkVmFsdW'
    'UuQXR0cmlidXRlc0VudHJ5UgphdHRyaWJ1dGVzGk4KD0F0dHJpYnV0ZXNFbnRyeRIQCgNrZXkY'
    'ASABKAlSA2tleRIlCgV2YWx1ZRgCIAEoCzIPLmNlZGFyLnY0LlZhbHVlUgV2YWx1ZToCOAE=');
...
const ExtensionCall$json = {
  ...
  '2': [
    ...
    {'1': 'arg', '3': 2, '4': 1, '5': 11, '6': '.cedar.v4.Value', '10': 'arg'},
  ],
};
...
final $typed_data.Uint8List extensionCallDescriptor = $convert.base64Decode(
    'Cg1FeHRlbnNpb25DYWxsEg4KAmZuGAEgASgJUgJmbhIhCgNhcmcYAiABKAsyDy5jZWRhci52NC'
    '5WYWx1ZVIDYXJn');
...
final $typed_data.Uint8List entityValueDescriptor = $convert.base64Decode(
    'CgtFbnRpdHlWYWx1ZRIlCgN1aWQYASABKAsyEy5jZWRhci52NC5FbnRpdHlVaWRSA3VpZA==');
