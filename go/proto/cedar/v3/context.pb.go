...
const file_cedar_v3_context_proto_rawDesc = "" +
	"\n" +
	"\x16cedar/v3/context.proto\x12\bcedar.v3\x1a\x14cedar/v3/value.proto\"\x8c\x01\n" +
	"\aContext\x125\n" +
	"\x06values\x18\x01 \x03(\v2\x1d.cedar.v3.Context.ValuesEntryR\x06values\x1aJ\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12%\n" +
	"\x05value\x18\x02 \x01(\v2\x0f.cedar.v3.ValueR\x05value:\x028\x01B\x94\x01\n" +
	"\fcom.cedar.v3B\fContextProtoP\x01Z5github.com/celest-dev/corks/go/proto/cedar/v3;cedarv3\xa2\x02\x03CXX\xaa\x02\bCedar.V3\xca\x02\bCedar\\V3\xe2\x02\x14Cedar\\V3\\GPBMetadata\xea\x02\tCedar::V3b\x06proto3"

var (
	file_cedar_v3_context_proto_rawDescOnce sync.Once
	file_cedar_v3_context_proto_rawDescData []byte
)

func file_cedar_v3_context_proto_rawDescGZIP() []byte {
	file_cedar_v3_context_proto_rawDescOnce.Do(func() {
		file_cedar_v3_context_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cedar_v3_context_proto_rawDesc), len(file_cedar_v3_context_proto_rawDesc)))
	})
...
func file_cedar_v3_context_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cedar_v3_context_proto_rawDesc), len(file_cedar_v3_context_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
